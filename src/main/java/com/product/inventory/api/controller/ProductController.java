...
public class ProductController {
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = ProductConstants.CREATE_PRODUCT_RESPONSE_CODE_400_DESCRIPTION, content = @Content) })
	...
	public ResponseEntity<ProductResponse> createProduct(@RequestBody Product product) {
		try {
			...
			return ResponseEntity
					.ok(new ProductResponse(true, ProductConstants.PRODUCT_CREATED_MESSAGE, createdProduct));
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = ProductConstants.ADD_MULTIPLE_PRODUCTS_RESPONSE_CODE_400_DESCRIPTION, content = @Content) })
	@PostMapping("/addProducts")
	@RateLimiter(name = ProductConstants.CREATE_PRODUCTS_LIMIT, fallbackMethod = ProductConstants.FALLBACK_INVENTORY_METHOD)
	public ResponseEntity<ProductResponse> addProducts(@RequestBody List<Product> products) {
		...
		try {
			...
			return ResponseEntity
					.ok(new ProductResponse(true, ProductConstants.PRODUCTS_CREATED_MESSAGE, createdProducts));
		} catch (ProductException e) {
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "404", description = ProductConstants.GET_PRODUCT_BY_ID_RESPONSE_CODE_404_DESCRIPTION, content = @Content) })
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = ProductConstants.UPDATE_PRODUCT_RESPONSE_CODE_400_DESCRIPTION, content = @Content),
			@ApiResponse(responseCode = "404", description = ProductConstants.UPDATE_PRODUCT_RESPONSE_CODE_404_DESCRIPTION, content = @Content) })
	...
	public ResponseEntity<ProductResponse> updateProduct(
		...
		try {
			...
			return ResponseEntity
					.ok(new ProductResponse(true, ProductConstants.PRODUCT_UPDATED_MESSAGE, updatedProduct));
		} catch (ProductException e) {
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = ProductConstants.DELETE_PRODUCT_API_RESPONSE_200_DESCRIPTION, content = @Content),
			@ApiResponse(responseCode = "404", description = ProductConstants.DELETE_PRODUCT_API_RESPONSE_404_DESCRIPTION, content = @Content) })
	...
	@GetMapping("/status")
	public ResponseEntity<ProductResponse> getProductsByStatus(
